      ...
      <body>
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-[60%_auto] items-center gap-8 md:gap-12 lg:gap-16 w-full max-w-7xl">
            <h1 className="w-full text-3xl sm:text-4xl md:text-5xl lg:text-6xl text-center md:text-left text-[var(--primary-600)] order-2 md:order-1 leading-relaxed md:leading-relaxed">
